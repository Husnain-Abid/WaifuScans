          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <div className="border border-gray-700 rounded-md overflow-hidden">
                <button
                  className={`w-full flex items-center justify-between px-4 py-3 text-left ${activeTab === "account" ? "bg-gray-800" : "hover:bg-gray-800"
                    }`}
                ...
                <button
                  className={`w-full flex items-center justify-between px-4 py-3 text-left border-t border-gray-700 ${activeTab === "password" ? "bg-gray-800" : "hover:bg-gray-800"
                    }`}
